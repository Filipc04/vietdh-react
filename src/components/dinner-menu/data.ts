...
export const dinnerMeals: DinnerMenu[] = [
  ...
  },
  {
    ...
    meals: [
      ...
      { text: 'Friterad anka med blandade grönsaker i szechuansås🌶️🌶️', price: 119 },
  ...
  },
  {
    ...
    meals: [
      ...
      { text: 'Wokade räkor med blandade grönsaker i szechuansås🌶️🌶️', price: 115 },
  ...
  },
  {
    mealCategory: 'Nudlar',
    meals: [
      { text: 'Wokade äggnudlar med kyckling & blandade grönsaker', price: 100 },
      { text: 'Wokade äggnudlar med biff & blandade grönsaker', price: 110 },
      { text: 'Wokade äggnudlar med räkor & blandade grönsaker', price: 110 },
      { text: 'Wokade äggnudlar med kyckling, biff samt räkor & blandade grönsaker', price: 110 },
    ]
  },
  {
    ...
    meals: [
      ...
      { text: 'Stekt ris med kyckling, räkor samt biff & grönsaker', price: 115 },
    ]
  },
  {
    ...
    meals: [
      ...
      { text: 'Risnudlar med räkor, biff samt kyckling & blandade grönsaker', price: 115 },
